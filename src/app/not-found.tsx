...
export default function NotFound() {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-6 text-center">
      <div className="w-24 h-24 bg-[#EBF4FB] rounded-full flex items-center justify-center mb-6 text-[#0095DA]">
      ...
      <h2 className="text-7xl md:text-8xl font-extrabold text-[#0A5486] mb-4 tracking-tight">404</h2>
