...
export default function Error({
  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-6 text-center">
      ...
      <h2 className="text-4xl md:text-5xl font-extrabold text-[#0A5486] mb-4 tracking-tight">Something went wrong</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <button
          onClick={() => reset()}
          className="bg-[#0095DA] text-white px-8 py-3.5 rounded-xl font-bold hover:bg-[#0095DA] transition-colors shadow-md"
        >
          Try Again
        </button>
        <Link 
          href="/"
          className="bg-white border border-slate-200 text-[#0A5486] px-8 py-3.5 rounded-xl font-bold hover:bg-slate-50 transition-colors"
        >
          Return Home
        </Link>
      </div>
