...
export default function PrivacyPolicyPage() {
  return (
    <div className="w-full bg-[#F8FAFC]">
      {/* Hero Section */}
      <section className="bg-[#0A5486] relative overflow-hidden py-24 md:py-32">
      ...
      <section className="py-20">
        <FadeInSection className="max-w-4xl mx-auto px-6" delay={0.2}>
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12 text-slate-600 leading-relaxed space-y-6">
            ...
            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">1. Information We Collect</h2>
            <p>We may collect the following types of information:</p>
            
            <h3 className="text-lg font-bold text-[#0095DA] mt-8 mb-3">a) Information You Provide Directly</h3>
            ...
            <h3 className="text-lg font-bold text-[#0095DA] mt-8 mb-3">b) Information Collected Automatically</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>IP address</li>
            ...
            <h3 className="text-lg font-bold text-[#0095DA] mt-8 mb-3">c) Information from Business Interactions</h3>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">2. How We Use Your Information</h2>
            ...
            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">3. How We Share Your Information</h2>
            <p>We do not sell your personal information. We may share information in the following circumstances:</p>
            <ul className="list-disc pl-6 space-y-3">
              <li><strong className="text-[#0A5486]">With service providers</strong>: third parties that help us operate our website, hosting, email, CRM, or automation tools (e.g., hosting providers, email service providers, form/automation platforms), solely to help us deliver our services.</li>
              <li><strong className="text-[#0A5486]">With business, government, or institutional partners</strong>: where necessary to fulfill a specific engagement (e.g., procurement, sourcing, supply chain, or institutional project) you or your organization have entered into with us.</li>
              <li><strong className="text-[#0A5486]">For legal reasons</strong>: if required by law, regulation, legal process, or governmental request, or to protect the rights, property, or safety of AlliedOne Limited, our clients, or others.</li>
              <li><strong className="text-[#0A5486]">Business transfers</strong>: in connection with a merger, acquisition, restructuring, or sale of assets, where permitted by law.</li>
            </ul>

            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">4. Data Retention</h2>
            ...
            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">5. Data Security</h2>
            ...
            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">6. Cookies and Tracking Technologies</h2>
            ...
            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">7. Third-Party Links and Services</h2>
            ...
            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">8. Children&apos;s Privacy (Educational Technology Services)</h2>
            ...
            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">9. Your Rights</h2>
            ...
            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">10. International Data Transfers</h2>
            ...
            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">11. Contact Us</h2>
            ...
            <div className="bg-[#F0F7FF] p-6 md:p-8 rounded-xl border border-blue-100 mt-6 shadow-sm">
              <p className="mb-2"><strong className="text-[#0A5486] text-lg">AlliedOne Limited</strong></p>
              <ul className="space-y-2 text-sm text-slate-700">
                <li><strong>Head Office:</strong> Dhaka, Bangladesh</li>
                <li><strong>Corporate Email:</strong> <a href="mailto:info@alliedoneltd.com" className="text-[#0095DA] font-semibold hover:underline">info@alliedoneltd.com</a></li>
                <li><strong>Website:</strong> <a href="http://www.alliedoneltd.com" className="text-[#0095DA] font-semibold hover:underline">www.alliedoneltd.com</a></li>
                <li><strong>Facebook:</strong> <a href="http://www.facebook.com/alliedoneltd" className="text-[#0095DA] font-semibold hover:underline">www.facebook.com/alliedoneltd</a></li>
                <li><strong>LinkedIn:</strong> <a href="http://www.linkedin.com/company/alliedoneltd" className="text-[#0095DA] font-semibold hover:underline">www.linkedin.com/company/alliedoneltd</a></li>
              </ul>
            </div>

            <h2 className="text-2xl font-extrabold text-[#0A5486] mt-12 mb-6 border-b border-slate-100 pb-3">12. Changes to This Privacy Policy</h2>
